...
const Card = ({ title, icon, children, className = "", theme = "blue" }) => {
  ...
  return (
    <section
      className={`bg-white rounded-[2.5rem] border shadow-sm p-8 transition-all hover:shadow-md ${className}`}
    >
      <h2
        className={`text-xs font-black mb-6 flex items-center gap-3 uppercase tracking-[0.2em] ${themes[theme]}`}
      >
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="text-center md:text-left flex-1 space-y-4">
              <div>
                ...
                <p className="text-2xl text-slate-400 font-bold mt-2 italic">
                  {student.userNameBn}
                </p>
              </div>
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            >
              ...
              <DataField
                ...
                value={student.extraCurriculumn}
                fullWidth
              />
            </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                <div className="col-span-full space-y-3 pt-2">
                  ...
                  <p className="text-sm font-bold text-slate-500 uppercase tracking-widest">
                    PO: {student.permanentPostOffice} (
                    {student.permanentPostCode})
                  </p>
                  <div className="h-px bg-slate-100 w-full my-2"></div>
            ...
            >
              <div className="col-span-full space-y-6">
                <PledgeBox
                  ...
                  text={student.studentPledge}
                />
                <PledgeBox
                  label="Guardian Commitment"
                  text={student.guardianPledge}
                />
              </div>
            </Card>
          </div>
            ...
            >
              <div className="col-span-full space-y-8">
                <RelationRow
                  ...
                  role="Father"
                  meta={student.fatherOccupation}
                  phone={student.fatherMobile}
                />
                <RelationRow
                  name={student.motherName}
                  role="Mother"
                  meta={student.motherOccupation}
                  phone={student.motherMobile}
                />
                <RelationRow
            ...
            >
              <div className="col-span-full space-y-4">
                <DocStatus
                  ...
                  status={Object.keys(student.docEducation || {}).length > 0}
                />
                <DocStatus
                  label="Identity (NID/Birth)"
                  status={Object.keys(student.docNIDBirth || {}).length > 0}
                />
                <DocStatus
                  label="Guardian Identity"
                  status={Object.keys(student.docGuardianNID || {}).length > 0}
                />
              </div>
            </Card>
          </div>
...
const Badge = ({ label, value, color, icon }) => {
  ...
  return (
    <div
      className={`px-6 py-3 rounded-2xl border-2 flex items-center gap-3 shadow-sm ${colors[color]}`}
    >
...
const PledgeBox = ({ label, text }) => (
  <div className="p-6 bg-slate-50 rounded-[2rem] border border-slate-100 relative group overflow-hidden">
    <div className="absolute top-0 right-0 p-4 opacity-5 text-4xl font-black italic select-none">
      PLEDGE
    </div>
