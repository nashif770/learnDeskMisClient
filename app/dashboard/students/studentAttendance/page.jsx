...
const StudentAttendance = () => {
  const { studentData } = useStudentData(); // Make sure your hook
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl fontold text-emerald-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="flex flex-col items-center p-4 bg-white rounded-lg shadow hover:shadow-lg transition">
          ...
          <p className="text-3xl fontold text-emerald-600">
            {totalFilteredStudents}
          </p>
        </div>
        ...
        <div className="flex flex-col items-center p-4 bg-white rounded-lg shadow hover:shadow-lg transition">
          ...
          <p className="text-3xl fontold textlue-600">
            {averageAttendance}%
          </p>
        </div>
        ...
        <div className="flex flex-col items-center p-4 bg-white rounded-lg shadow hover:shadow-lg transition">
          ...
          <p className="text-3xl fontold text-purple-600">{totalClassDays}</p>
        </div>
      </div>
        ...
        <table className="min-w-full bg-white rounded-lg">
          <thead className="bg-gray-100 text-gray-700">
            <tr>
              ...
              <th className="p-3 border text-center">Total Class</th>
            ...
            {filteredData.length > 0 ? (
              filteredData.map((s, index) => (
                <tr key={s.id} className="hover:bg-gray-50 transition">
                  <td className="p-3 border text-center w-3">{index+1 }</td>
                  ...
                  <td className="p-3 border text-center font-semibold textlue-600">
